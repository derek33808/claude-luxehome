...
export const products: Product[] = [
  {
    ...
    images: [
      ...
      {
        url: '/images/products/smart-digital-calendar/white/calendar-view.jpg',
        alt: 'Smart Digital Calendar - Weekly Calendar View',
      },
      {
        url: '/images/products/smart-digital-calendar/white/chore-chart.jpg',
        alt: 'Smart Digital Calendar - Chore Chart Feature',
      },
      {
        url: '/images/products/smart-digital-calendar/white/meal-planner.jpg',
        alt: 'Smart Digital Calendar - Meal Planner Feature',
      },
      {
        url: '/images/products/smart-digital-calendar/white/photo-frame.jpg',
        alt: 'Smart Digital Calendar - Photo Frame Mode',
      },
      {
        url: '/images/products/smart-digital-calendar/white/family-hub.jpg',
        alt: 'Smart Digital Calendar - Family Command Center',
      },
      {
        url: '/images/products/smart-digital-calendar/white/lifestyle.jpg',
        alt: 'Smart Digital Calendar - In Home Setting',
      },
    ],
    colorVariants: [
      {
        ...
        images: [
          ...
          { url: '/images/products/smart-digital-calendar/white/calendar-view.jpg', alt: 'White Frame - Calendar' },
          { url: '/images/products/smart-digital-calendar/white/chore-chart.jpg', alt: 'White Frame - Chore Chart' },
          { url: '/images/products/smart-digital-calendar/white/meal-planner.jpg', alt: 'White Frame - Meal Planner' },
          { url: '/images/products/smart-digital-calendar/white/photo-frame.jpg', alt: 'White Frame - Photo Frame' },
          { url: '/images/products/smart-digital-calendar/white/family-hub.jpg', alt: 'White Frame - Family Hub' },
          { url: '/images/products/smart-digital-calendar/white/lifestyle.jpg', alt: 'White Frame - Lifestyle' },
        ],
        inStock: true,
        stockCount: 12,
      },
      {
        ...
        color: '#6B7280',
        images: [
          { url: '/images/products/smart-digital-calendar/grey/main.jpg', alt: 'Grey Frame - Main' },
        ],
        inStock: true,
        stockCount: 14,
      },
      {
        ...
        color: '#F9FAFB',
        images: [
          { url: '/images/products/smart-digital-calendar/snow-white/main.jpg', alt: 'Snow White Frame - Main' },
        ],
        inStock: true,
        stockCount: 5,
      },
